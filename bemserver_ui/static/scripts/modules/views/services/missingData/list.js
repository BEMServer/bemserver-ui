...
class CheckMissingDataServiceListView {
    ...
    #createEntryElement(entryData) {
        ...
        let manageUrl = flaskES6.urlFor(`services.missing_data.campaign_state`, {id: entryData["campaign_id"]});
        if (isSelected) {
            manageUrl = flaskES6.urlFor(`services.missing_data.campaign_context_state`);
        }
        else if (entryData["id"] != null) {
            manageUrl = flaskES6.urlFor(`services.missing_data.service_state`, {id: entryData["id"]});
        }
